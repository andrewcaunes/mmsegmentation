...
def apolloscape_classes():
    """Apolloscape class names for external use."""
    return [
        'void', 's_w_d', 's_y_d', 'ds_w_dn', 'ds_y_dn', 'sb_w_do', 'sb_y_do', 'b_w_g', 'b_y_g', 'db_w_g', 
...
def apolloscape_palette():
    """Apolloscape palette for external use."""
    return [[0,   0,   0], [ 70, 130, 180], [220,  20,  60], [128,   0, 128], [255, 0,   0], [  0,   0,  60],
