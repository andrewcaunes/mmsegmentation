...
class MapillaryDataset_v1_static_bg_nbs(BaseSegDataset):
    ...
    """
    METAINFO = dict(
        classes=('background', 'road', 'sidewalk', 'building', 'vegetation', 'terrain',
                 'sky'),#, 'person', 'rider', 'car', 'truck', 'bus', 'train',
                 #'motorcycle', 'bicycle'),
        palette=[[10, 10, 10], [128, 64, 128], [244, 35, 232], [100, 100, 100], [30, 230, 30],
                 [150, 150, 30], [50, 50, 200]])
    ...
    def __init__(self,
                 img_suffix='.jpg',
                 seg_map_suffix='_static_bg_nbs.png',
                 **kwargs) -> None:
        super().__init__(
